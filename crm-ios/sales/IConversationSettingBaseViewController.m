//
//  IConversationSettingBaseViewController.m
//  sales
//
...
@property(nonatomic, strong) IConversationSettingTableViewHeader *header;
...
@implementation IConversationSettingBaseViewController
...
- (void)viewDidLoad {
    ...
    _header = [[IConversationSettingTableViewHeader alloc] init];
